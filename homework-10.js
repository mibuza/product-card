...
function renderProducts() {
  products.forEach((product) => {
    ...
    const productImage = productClone.querySelector(".card__img")

    productImage.src = product.Image;
    
    productClone.querySelector(".card__product-name").textContent = product.name;
    productClone.querySelector(".card__price-value").textContent =`${product.price} ₽`;
    ...
    productClone.querySelector(".compound__item1").textContent =product.compound[0];
    productClone.querySelector(".compound__item2").textContent =product.compound[1];
    productClone.querySelector(".compound__item3").textContent =product.compound[2];
